...
def write_news_data_to_csv(news_data):
    ...
    try:
        with open('news_data_2022_first.csv', 'r', newline='', encoding='utf-8') as file:
    ...
    with open('news_data_2022_first.csv', 'a', newline='', encoding='utf-8') as file:
...
while True:
    ...
    time.sleep(7)  # Add a delay of 15 seconds before fetching the next batch