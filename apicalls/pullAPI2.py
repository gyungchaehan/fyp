...
def write_news_data_to_csv(news_data):
    ...
    try:
        with open('news_data_2022_third.csv', 'r', newline='', encoding='utf-8') as file:
    ...
    with open('news_data_2022_third.csv', 'a', newline='', encoding='utf-8') as file:
