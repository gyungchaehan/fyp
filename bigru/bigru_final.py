...
if __name__ == "__main__":
    ...
    X_train, X_test, y_train, y_test = sequence_and_split(features, label)
    ...
    metrics_dict, actual_prices, pred_prices = evaluate_model(best_model, X_test, y_test, label_scaler)
